...
def getTemperature():
    ...
    if temperatura_exterior is not None:
        if temperatura_exterior < -30 or temperatura_exterior > 70:
...
while True:
    try:
        ...
        # Send data to broker every 15 seconds
        if time.ticks_diff(time.ticks_ms(), last_update) > 15000: # 15 seconds
